  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="card-header-action">
        ...
        <form method="GET" action="{{ route('user.student') }}">
          <div class="input-group">
            <a href="{{ route('student.print') }}" class="btn btn-primary" data-toggle="tooltip" style="margin-right: 10px;" title="Cetak Kartu"><i class="fas fa-print"></i> Cetak Kartu Terpilih</a>
